...
def your_view_function(request):
    # Assuming you have a model called 'YourModel' and 'math_score' is a field in the model
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            # Predict math scores for the new student using Linear Regression model
